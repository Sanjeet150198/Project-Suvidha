            ...
            <h3>Admin Login</h3>
	            <form action="<?php htmlspecialchars($_SERVER['PHP_SELF'])?>" method="post">
                    ...
                    <div class="form-group has-success">
                        ...
                        <button type="submit" class="btn btn-primary"><a href="registration.php" style="color:#fff; display:block;"><span class="glyphicon glyphicon-send"> </span>  SignUp !</a></button>
                    </div>
                </form>
                </div>
            </div>
